...
<div class="box-header">
    ...
    <div class="pull-right box-tools">
    	<button class="btn btn-info btn-sm" id="nuevo_uni"  data-toggle="tooltip" title="Nueva Unidad"><i class="fa fa-plus" aria-hidden="true"></i></button> 
...
<table id="tabla" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
	...
	<?php foreach($listado as $fila){ ?>
			<tr>
				...
				<td align='center'> 
				<a class="btn btn-danger borrar_uni" href="#" data-toggle="tooltip" codigo="<?php echo  $fila['uni_codi'] ?>">
  					<i class="fa fa-trash-o"  aria-hidden="true"></i>
  					<span class="sr-only">Delete</span>
				</a> </td> 
				<td align='center'>
				<a class="btn btn-primary editar_uni" href="#" data-toggle="tooltip" codigo="<?php echo $fila['uni_codi'] ?>">
