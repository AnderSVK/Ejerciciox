...
$pdf->Cell(18, 10, '', 0);
$pdf->Cell(150, 10, 'Listado de Alquiler"', 0);
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(50, 10, 'Fecha: '.date('d-m-Y').'', 0);
$pdf->Ln(15);
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE ALQUILER', 0);
$pdf->Ln(23);
...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysql_query("SELECT alquizona_codi, p.zona_nomb, a.inqui_nomb
...
while($productos2 = mysql_fetch_array($productos)){
	$pdf->Cell(15, 8, $productos2['alquizona_codi'], 0);
	$pdf->Cell(80, 8,$productos2['zona_nomb'], 0);
